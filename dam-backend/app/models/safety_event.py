...
class SafetyEvent(Base):
    ...
    video_status = Column(String(32), nullable=False, default="PENDING", index=True, comment="留证视频状态")
    video_error = Column(String(500), comment="留证视频失败原因")
    video_created_at = Column(DateTime, comment="留证视频生成完成时间")
    video_expires_at = Column(DateTime, index=True, comment="留证视频留档到期时间")
