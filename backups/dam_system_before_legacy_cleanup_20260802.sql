...
--
-- Host: localhost    Database: dam_system
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='行为流程库';
...
INSERT INTO `action_flow` VALUES (5,'一般预警处理流程','GENERAL_ALERT',120,'skip','一般预警事件的处理流程',1,'2026-07-04 16:25:01','2026-07-04 16:25:01'),(6,'紧急告警处理流程','EMERGENCY_ALERT',60,'abort','紧急告警事件的处理流程',1,'2026-07-04 16:25:01','2026-07-04 16:25:01'),(9,'风灾预警响应流程','WIND_WARNING',120,'continue','6-7级风预警，只做监测记录',1,'2026-07-07 10:23:37','2026-07-07 10:23:37'),(10,'风灾警报响应流程','WIND_ALERT',180,'continue','8-9级风警报，YOLO检测+告警',1,'2026-07-07 10:23:37','2026-07-07 10:23:37'),(11,'风灾紧急响应流程','WIND_EMERGENCY',300,'continue','10级以上风灾，全模型分析+紧急告警',1,'2026-07-07 10:23:37','2026-07-07 10:23:37'),(12,'风灾裂缝响应流程','WIND_CRACK_RESPONSE',300,'continue','风灾导致裂缝的应急响应',1,'2026-07-07 10:47:26','2026-07-07 10:47:26'),(13,'风灾渗水响应流程','WIND_SEEPAGE_RESPONSE',300,'continue','风灾导致渗水的应急响应',1,'2026-07-07 10:47:26','2026-07-07 10:47:26'),(14,'风灾护坡损坏响应流程','WIND_SLOPE_RESPONSE',300,'continue','风灾导致护坡损坏的应急响应',1,'2026-07-07 10:47:26','2026-07-07 10:47:26'),(15,'风灾闸门变形响应流程','WIND_GATE_RESPONSE',300,'continue','风灾导致闸门变形的应急响应',1,'2026-07-07 10:47:26','2026-07-07 10:47:26'),(16,'温度告警响应流程','TEMP_ALERT',120,'continue','温度异常告警响应',1,'2026-07-08 15:51:14','2026-07-08 15:51:14'),(17,'湿度告警流程','HUMIDITY_ALERT',120,'continue','湿度异常告警',1,'2026-07-08 16:51:18','2026-07-08 16:51:18'),(18,'测试Qwen流程','TEST_QWEN_FLOW',300,'continue','测试Qwen模型调用',1,'2026-07-09 10:05:31','2026-07-09 10:05:31'),(19,'人员闯入预警处理流程','PERSON_INTRUSION_FLOW',60,'continue','视觉事件统一安全闭环流程',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(20,'人员亲水预警处理流程','PERSON_WATERFRONT_FLOW',120,'continue','视觉事件统一安全闭环流程',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(21,'人员涉水预警处理流程','PERSON_WADING_FLOW',60,'continue','视觉事件统一安全闭环流程',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(22,'船只闯入预警处理流程','BOAT_INTRUSION_FLOW',60,'continue','视觉事件统一安全闭环流程',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(23,'船只停留预警处理流程','BOAT_STAY_FLOW',120,'continue','视觉事件统一安全闭环流程',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(24,'船只偷捕预警处理流程','BOAT_ILLEGAL_FISHING_FLOW',60,'continue','视觉事件统一安全闭环流程',1,'2026-08-02 19:33:03','2026-08-02 19:33:03');
...
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='行为步骤库';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `broadcast_device` VALUES (1,'本机耳机/音响测试','LOCAL_AUDIO','local_audio_default',NULL,NULL,NULL,NULL,'OFFLINE','浏览器本机',0,NULL,'2026-07-25 11:25:26','2026-07-31 06:27:42',NULL),(2,'Jetson USB外放','USB_AUDIO','jetson_usb_speaker',NULL,NULL,NULL,NULL,'ONLINE','Jetson USB音频输出',1,'{\"alsa_device\": \"plughw:2,0\"}','2026-07-30 06:26:14','2026-07-31 06:18:28',NULL);
...
INSERT INTO `camera_broadcast_device` VALUES (1,'dahua_001',1,'2026-07-25 11:25:26',NULL),(2,'dahua_001',2,'2026-07-30 06:26:14',NULL);
...
CREATE TABLE `camera_detection_zone` (
  ...
  `rect_x` decimal(8,6) DEFAULT NULL,
  `rect_y` decimal(8,6) DEFAULT NULL,
  `rect_width` decimal(8,6) DEFAULT NULL,
  `rect_height` decimal(8,6) DEFAULT NULL,
...
INSERT INTO `camera_detection_zone` VALUES (8,'dahua_001','警戒区 1','PERSON_LOW',0.133618,0.333929,0.230277,0.283928,1,'2026-07-29 13:36:13','2026-08-02 12:15:01','WARNING_ZONE_1785159705817','[{\"x\": 0.133618, \"y\": 0.333929}, {\"x\": 0.363895, \"y\": 0.421429}, {\"x\": 0.146411, \"y\": 0.617857}]','LOW',5.000,1),(9,'camera_zone','入口禁入区','PERSON_LOW',0.100000,0.200000,0.300000,0.400000,1,'2026-07-30 13:35:16','2026-08-02 19:33:03','entry_area','[{\"x\": 0.1, \"y\": 0.2}, {\"x\": 0.4, \"y\": 0.2}, {\"x\": 0.4, \"y\": 0.6}, {\"x\": 0.1, \"y\": 0.6}]','LOW',5.000,NULL);
...
CREATE TABLE `camera_device` (
  ...
  UNIQUE KEY `uq_camera_device_name` (`camera_name`),
...
--
-- Table structure for table `camera_zone_condition`
--

DROP TABLE IF EXISTS `camera_zone_condition`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `camera_zone_condition` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_zone_condition` (`zone_id`,`condition_id`),
  KEY `ix_camera_zone_condition_enabled` (`enabled`),
  KEY `ix_camera_zone_condition_condition_id` (`condition_id`),
  KEY `ix_camera_zone_condition_zone_id` (`zone_id`),
  CONSTRAINT `camera_zone_condition_ibfk_1` FOREIGN KEY (`zone_id`) REFERENCES `camera_detection_zone` (`id`) ON DELETE CASCADE,
  CONSTRAINT `camera_zone_condition_ibfk_2` FOREIGN KEY (`condition_id`) REFERENCES `condition_library` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `camera_zone_condition`
--

LOCK TABLES `camera_zone_condition` WRITE;
/*!40000 ALTER TABLE `camera_zone_condition` DISABLE KEYS */;
INSERT INTO `camera_zone_condition` VALUES (1,8,37,1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(2,9,37,1,'2026-08-02 19:33:03','2026-08-02 19:33:03');
/*!40000 ALTER TABLE `camera_zone_condition` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='条件库';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `data_source` (
  ...
  KEY `idx_device_id` (`device_id`),
  KEY `idx_is_activate` (`is_activate`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='数据源表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='事件-行为关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event_action_step_config` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_event_camera_step_config` (`event_action_id`,`camera_id`,`step_id`),
  KEY `broadcast_device_id` (`broadcast_device_id`),
  KEY `template_id` (`template_id`),
  KEY `ix_event_action_step_config_camera_id` (`camera_id`),
  KEY `ix_event_action_step_config_event_action_id` (`event_action_id`),
  KEY `ix_event_action_step_config_step_id` (`step_id`),
  KEY `ix_event_action_step_config_enabled` (`enabled`),
  CONSTRAINT `event_action_step_config_ibfk_1` FOREIGN KEY (`event_action_id`) REFERENCES `event_action` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_action_step_config_ibfk_2` FOREIGN KEY (`camera_id`) REFERENCES `camera_device` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_action_step_config_ibfk_3` FOREIGN KEY (`step_id`) REFERENCES `action_step` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_action_step_config_ibfk_4` FOREIGN KEY (`broadcast_device_id`) REFERENCES `broadcast_device` (`id`) ON DELETE SET NULL,
  CONSTRAINT `event_action_step_config_ibfk_5` FOREIGN KEY (`template_id`) REFERENCES `broadcast_template` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `event_action_step_config`
--

LOCK TABLES `event_action_step_config` WRITE;
/*!40000 ALTER TABLE `event_action_step_config` DISABLE KEYS */;
INSERT INTO `event_action_step_config` VALUES (1,115,1,41,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": true, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(2,115,1,42,2,'PERSON_LOW',NULL,NULL,'{\"max_executions\": 3, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(3,116,1,43,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": true, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(4,116,1,44,2,'PERSON_MEDIUM',NULL,NULL,'{\"max_executions\": 3, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(5,116,1,45,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(6,117,1,46,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": true, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(7,117,1,47,2,'PERSON_HIGH',NULL,NULL,'{\"max_executions\": 3, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(8,117,1,48,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(9,118,1,49,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": true, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(10,118,1,50,2,'FISHING',NULL,NULL,'{\"max_executions\": 3, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(11,119,1,51,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": true, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(12,119,1,52,2,'FISHING',NULL,NULL,'{\"max_executions\": 3, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(13,119,1,53,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(14,120,1,54,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": true, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(15,120,1,55,2,'FISHING',NULL,NULL,'{\"max_executions\": 3, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(16,120,1,56,NULL,NULL,NULL,NULL,'{\"max_executions\": 1, \"capture_on_resolve\": false, \"repeat_interval_seconds\": 60}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03');
/*!40000 ALTER TABLE `event_action_step_config` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='事件-条件关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event_library` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `recovery_duration` int NOT NULL DEFAULT '60',
  PRIMARY KEY (`id`),
  UNIQUE KEY `event_code` (`event_code`),
  KEY `idx_event_code` (`event_code`),
  KEY `idx_event_category` (`event_category`),
  KEY `idx_risk_level` (`risk_level`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='事件库';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_library` VALUES (22,'大风告警','WIND_LEVEL_6','environment',1,'single','6级强风预警，需关注',1,'2026-07-07 10:23:37','2026-07-07 15:23:14',60),(23,'强风告警','WIND_LEVEL_7','environment',1,'single','7级疾风预警，需注意',1,'2026-07-07 10:23:37','2026-07-07 15:23:14',60),(24,'大风警报','WIND_LEVEL_8','environment',2,'single','8级大风警报，危险',1,'2026-07-07 10:23:37','2026-07-07 10:23:37',60),(25,'烈风警报','WIND_LEVEL_9','environment',2,'single','9级烈风警报，建筑物可能损坏',1,'2026-07-07 10:23:37','2026-07-07 10:23:37',60),(26,'狂风警报','WIND_LEVEL_10','environment',3,'single','10级狂风警报，树木拔起，立即避险',1,'2026-07-07 10:23:37','2026-07-07 10:23:37',60),(27,'暴风警报','WIND_LEVEL_11','environment',3,'single','11级暴风警报，重大损毁风险',1,'2026-07-07 10:23:37','2026-07-07 10:23:37',60),(28,'飓风警报','WIND_LEVEL_12','environment',3,'single','12级飓风警报，极端危险',1,'2026-07-07 10:23:37','2026-07-07 10:23:37',60),(33,'极低温告警','TEMP_EXTREME_LOW','environment',3,'single','温度<-10℃，高风险',1,'2026-07-08 15:51:13','2026-07-08 15:51:13',60),(34,'低温告警','TEMP_LOW','environment',2,'single','温度-10~0℃，中风险',1,'2026-07-08 15:51:13','2026-07-08 15:51:13',60),(35,'高温告警','TEMP_HIGH','environment',2,'single','温度35~40℃，中风险',1,'2026-07-08 15:51:13','2026-07-08 15:51:13',60),(36,'极高温告警','TEMP_EXTREME_HIGH','environment',3,'single','温度≥40℃，高风险',1,'2026-07-08 15:51:13','2026-07-08 15:51:13',60),(38,'冰冻风险告警','FREEZE_RISK','environment',3,'single','低温触发冰冻风险告警',1,'2026-07-08 15:51:13','2026-07-30 16:21:01',60),(39,'极高湿事件','HUMIDITY_VERY_HIGH','environment',1,'single','相对湿度≥90%，空气接近饱和',1,'2026-07-08 16:50:39','2026-07-08 16:50:39',60),(40,'高湿事件','HUMIDITY_HIGH','environment',2,'single','相对湿度80%-90%，易凝露结霜',1,'2026-07-08 16:50:39','2026-07-08 16:50:39',60),(41,'低湿事件','HUMIDITY_LOW','environment',2,'single','相对湿度20%-30%，偏干燥',1,'2026-07-08 16:50:39','2026-07-08 16:50:39',60),(42,'极低湿事件','HUMIDITY_VERY_LOW','environment',1,'single','相对湿度<20%，极度干燥',1,'2026-07-08 16:50:39','2026-07-08 16:50:39',60),(44,'泥石流灾害告警','AI_MUDSLIDE','environment',3,'single','摄像头AI检测到泥石流灾害，触发告警',1,'2026-07-30 17:24:03','2026-07-30 17:34:00',60),(45,'滑坡灾害告警','AI_LANDSLIDE','environment',3,'single','摄像头AI检测到滑坡灾害，触发告警',1,'2026-07-30 17:24:03','2026-07-30 17:26:31',60),(46,'地震灾害告警','AI_EARTHQUAKE','environment',3,'single','摄像头AI检测到地震灾害，触发告警',1,'2026-07-30 17:24:03','2026-07-30 17:26:29',60),(47,'洪水灾害告警','AI_FLOOD','environment',3,'single','摄像头AI检测到洪水灾害，触发告警',1,'2026-07-30 17:24:03','2026-07-30 17:26:27',60),(48,'人员闯入','PERSON_INTRUSION','PERSON_SAFETY',1,'single','摄像头检测到人员进入低风险区域，触发告警',1,'2026-08-02 19:33:03','2026-08-02 19:33:03',10),(49,'人员亲水','PERSON_WATERFRONT','PERSON_SAFETY',2,'single','摄像头检测到人员进入中风险区域，触发告警',1,'2026-08-02 19:33:03','2026-08-02 19:33:03',10),(50,'人员涉水','PERSON_WADING','PERSON_SAFETY',3,'single','摄像头检测到人员进入高风险区域，触发告警',1,'2026-08-02 19:33:03','2026-08-02 19:33:03',10),(51,'船只闯入','BOAT_INTRUSION','ILLEGAL_FISHING',1,'single','摄像头检测到船只闯入捕鱼区，触发告警',1,'2026-08-02 19:33:03','2026-08-02 19:33:03',10),(52,'船只停留','BOAT_STAY','ILLEGAL_FISHING',2,'single','摄像头检测到船只持续停留，触发告警',1,'2026-08-02 19:33:03','2026-08-02 19:33:03',10),(53,'船只偷捕','BOAT_ILLEGAL_FISHING','ILLEGAL_FISHING',3,'single','摄像头检测到船只长时间停留捕鱼，触发告警',1,'2026-08-02 19:33:03','2026-08-02 19:33:03',10);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI视频安全事件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `safety_event_evidence` (
  ...
  `timeline_log_id` bigint DEFAULT NULL,
  `task_id` bigint DEFAULT NULL,
  `evidence_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_safety_event_evidence_timeline_log_id` (`timeline_log_id`),
  KEY `ix_safety_event_evidence_evidence_type` (`evidence_type`),
  KEY `ix_safety_event_evidence_task_id` (`task_id`),
  KEY `ix_safety_event_evidence_captured_at` (`captured_at`),
  KEY `ix_safety_event_evidence_event_instance_id` (`event_instance_id`),
  KEY `ix_safety_event_evidence_source_type` (`source_type`),
  CONSTRAINT `safety_event_evidence_ibfk_1` FOREIGN KEY (`event_instance_id`) REFERENCES `safety_event_instance` (`id`) ON DELETE CASCADE,
  CONSTRAINT `safety_event_evidence_ibfk_2` FOREIGN KEY (`timeline_log_id`) REFERENCES `safety_event_timeline_log` (`id`) ON DELETE SET NULL,
  CONSTRAINT `safety_event_evidence_ibfk_3` FOREIGN KEY (`task_id`) REFERENCES `safety_event_task` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `safety_event_evidence` VALUES (1,6,NULL,NULL,'IMAGE','CAMERA','camera_test','/app/data/safety_snapshots/1785674381_evt_a46cba8199df4732ab77a5836112e75b.jpg','事件触发抓拍',NULL,'2026-08-02 12:39:41','2026-08-02 12:40:58'),(2,6,NULL,NULL,'VIDEO','CAMERA','camera_test','/app/data/safety_event_videos/2026-08-02/camera_test/evt_a46cba8199df4732ab77a5836112e75b.mp4','事件留证视频',NULL,'2026-08-02 12:39:41','2026-08-02 12:40:58');
/*!40000 ALTER TABLE `safety_event_evidence` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `safety_event_instance`
--

DROP TABLE IF EXISTS `safety_event_instance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `safety_event_instance` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `instance_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `max_risk_level` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `state` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `started_at` datetime NOT NULL,
  `last_observed_at` datetime NOT NULL,
  `resolved_at` datetime DEFAULT NULL,
  `resolve_reason` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `summary` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `latest_observation` json DEFAULT NULL,
  `version` int NOT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ix_safety_event_instance_instance_no` (`instance_no`),
  KEY `ix_safety_event_instance_current_event_id` (`current_event_id`),
  KEY `ix_safety_event_instance_risk_level` (`risk_level`),
  KEY `ix_safety_event_instance_event_category` (`event_category`),
  KEY `ix_safety_event_instance_last_observed_at` (`last_observed_at`),
  KEY `ix_safety_event_instance_state` (`state`),
  KEY `ix_safety_event_instance_source_id` (`source_id`),
  KEY `ix_safety_event_instance_started_at` (`started_at`),
  KEY `ix_safety_event_instance_max_risk_level` (`max_risk_level`),
  KEY `ix_safety_event_instance_source_type` (`source_type`),
  KEY `ix_safety_event_instance_data_source_id` (`data_source_id`),
  KEY `ix_safety_event_instance_resolved_at` (`resolved_at`),
  KEY `ix_safety_event_instance_status` (`status`),
  CONSTRAINT `safety_event_instance_ibfk_1` FOREIGN KEY (`current_event_id`) REFERENCES `event_library` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `safety_event_instance_ibfk_2` FOREIGN KEY (`data_source_id`) REFERENCES `data_source` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `safety_event_instance`
--

LOCK TABLES `safety_event_instance` WRITE;
/*!40000 ALTER TABLE `safety_event_instance` DISABLE KEYS */;
INSERT INTO `safety_event_instance` VALUES (1,'mp_demo_low_001',48,'PERSON_SAFETY',7,'camera',1,'LOW','LOW','ACTIVE','PROCESSING','2026-07-30 08:12:00','2026-07-30 08:15:00',NULL,NULL,'一号点摄像头 - 人员闯入','{\"source\": \"miniprogram_demo\", \"confidence\": 0.91}',3,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(2,'mp_demo_medium_001',49,'PERSON_SAFETY',7,'camera',1,'MEDIUM','MEDIUM','ACTIVE','PROCESSING','2026-07-30 08:10:40','2026-07-30 08:15:00',NULL,NULL,'一号点摄像头 - 人员亲水','{\"source\": \"miniprogram_demo\", \"confidence\": 0.91}',1,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(3,'mp_demo_high_001',50,'PERSON_SAFETY',7,'camera',1,'HIGH','HIGH','RESOLVED','COMPLETED','2026-07-30 08:08:00','2026-07-30 08:15:00','2026-07-30 14:24:24','manual_close','一号点摄像头 - 人员涉水','{\"source\": \"miniprogram_demo\", \"confidence\": 0.91}',4,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(4,'mp_demo_high_processing_001',50,'PERSON_SAFETY',7,'camera',1,'HIGH','HIGH','RESOLVED','COMPLETED','2026-07-30 08:04:40','2026-07-30 08:15:00','2026-08-02 07:46:23','manual_close','一号点摄像头 - 人员涉水','{\"source\": \"miniprogram_demo\", \"confidence\": 0.91}',2,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(5,'mp_demo_high_processing_002',50,'PERSON_SAFETY',7,'camera',1,'HIGH','HIGH','ACTIVE','PROCESSING','2026-07-30 08:04:40','2026-07-30 08:15:00',NULL,NULL,'一号点摄像头 - 人员涉水','{\"source\": \"miniprogram_demo\", \"confidence\": 0.91}',2,'2026-08-02 19:33:03','2026-08-02 19:33:03'),(6,'evt_a46cba8199df4732ab77a5836112e75b',51,'ILLEGAL_FISHING',7,'camera',NULL,'MEDIUM','MEDIUM','ACTIVE','PENDING','2026-08-02 12:39:41','2026-08-02 12:39:41',NULL,NULL,'camera_test - 船只闯入','{\"bbox\": {\"x1\": 10.0, \"x2\": 60.0, \"y1\": 10.0, \"y2\": 55.0}, \"zone_ids\": [\"fish_area\"], \"camera_id\": \"camera_test\", \"timestamp\": 1785674381.158438, \"class_name\": \"boat\", \"confidence\": 0.91, \"zone_names\": [\"禁捕区\"], \"zone_roles\": [\"FISHING\"], \"zone_types\": [\"FISHING\"], \"entity_type\": \"boat\", \"class_name_cn\": \"船只\", \"detection_index\": 0, \"trigger_seconds\": {}, \"provided_track_id\": null, \"condition_durations\": {}}',1,'2026-08-02 12:40:58','2026-08-02 13:20:36');
/*!40000 ALTER TABLE `safety_event_instance` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI视频安全事件动作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `safety_event_task` (
  ...
  `result_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `result_remark` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `safety_event_task` VALUES (1,'mp_demo_high_processing_001','演示人员',NULL,'SYSTEM','COMPLETED','小程序演示：工作人员主动现场处理','2026-07-30 08:06:40','2026-08-02 07:46:23','2026-07-30 08:07:40',4,NULL,NULL,'2026-08-02 19:32:57','2026-08-02 12:41:41'),(2,'mp_demo_high_001','微信小程序工作人员',NULL,'SYSTEM','COMPLETED','小程序工作人员主动现场处理','2026-07-30 08:24:48','2026-07-30 14:24:24','2026-07-30 08:24:48',3,NULL,NULL,'2026-08-02 19:32:57','2026-08-02 12:41:41');
/*!40000 ALTER TABLE `safety_event_task` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `safety_event_timeline_log`
--

DROP TABLE IF EXISTS `safety_event_timeline_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `safety_event_timeline_log` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `event_instance_id` bigint NOT NULL,
  `event_id` bigint DEFAULT NULL,
  ...
  `action_key` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `log_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `flow_id` (`flow_id`),
  KEY `step_id` (`step_id`),
  KEY `ix_safety_event_timeline_log_log_type` (`log_type`),
  KEY `ix_safety_event_timeline_log_event_instance_id` (`event_instance_id`),
  KEY `ix_safety_event_timeline_log_status` (`status`),
  KEY `ix_safety_event_timeline_log_event_id` (`event_id`),
  KEY `ix_safety_event_timeline_log_risk_level` (`risk_level`),
  KEY `ix_safety_event_timeline_log_create_time` (`create_time`),
  CONSTRAINT `safety_event_timeline_log_ibfk_1` FOREIGN KEY (`event_instance_id`) REFERENCES `safety_event_instance` (`id`) ON DELETE CASCADE,
  CONSTRAINT `safety_event_timeline_log_ibfk_2` FOREIGN KEY (`event_id`) REFERENCES `event_library` (`id`) ON DELETE SET NULL,
  CONSTRAINT `safety_event_timeline_log_ibfk_3` FOREIGN KEY (`condition_id`) REFERENCES `condition_library` (`id`) ON DELETE SET NULL,
  CONSTRAINT `safety_event_timeline_log_ibfk_4` FOREIGN KEY (`flow_id`) REFERENCES `action_flow` (`id`) ON DELETE SET NULL,
  CONSTRAINT `safety_event_timeline_log_ibfk_5` FOREIGN KEY (`step_id`) REFERENCES `action_step` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `safety_event_timeline_log`
--

LOCK TABLES `safety_event_timeline_log` WRITE;
/*!40000 ALTER TABLE `safety_event_timeline_log` DISABLE KEYS */;
INSERT INTO `safety_event_timeline_log` VALUES (1,1,48,NULL,NULL,NULL,'legacy:02a9b184cb6a46ca9de23ee2c1e3ffd4','ACTION','AUTO','LOW','SUCCESS','检测到人员','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"AI_DETECTED\"}','2026-07-30 08:12:00','2026-08-02 19:33:03'),(2,1,48,NULL,NULL,NULL,'legacy:4f78748ae6ae40eab79eb73716460f52','ACTION','AUTO','LOW','SUCCESS','低风险，自动喊话','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_LOW\"}','2026-07-30 08:12:10','2026-08-02 19:33:03'),(3,1,48,NULL,NULL,NULL,'legacy:f2a29cba11874458a9ac5b5374ddcbb8','ACTION','MANUAL','LOW','SUCCESS','PARTIAL_SUCCESS','微信小程序工作人员','{\"legacy_payload\": {\"reason\": null, \"remark\": null, \"content\": null, \"assignee\": null, \"operator\": \"微信小程序工作人员\", \"to_status\": \"PROCESSING\", \"device_ids\": [], \"from_status\": \"PROCESSING\", \"template_id\": \"PERSON_LOW\", \"operator_role\": \"miniprogram\", \"assignee_phone\": null, \"broadcast_result\": {\"text\": \"您已进入安全警戒区域，请立即远离水边危险区域。\", \"items\": [{\"result\": \"SUCCESS\", \"message\": \"LOCAL_AUDIO accepted\", \"device_id\": 1, \"device_name\": \"本机耳机/音响测试\", \"vendor_type\": \"LOCAL_AUDIO\"}, {\"result\": \"FAILED\", \"message\": \"USB_AUDIO only supports recorded audio playback\", \"device_id\": 2, \"device_name\": \"Jetson USB外放\", \"vendor_type\": \"USB_AUDIO\"}], \"result\": \"PARTIAL_SUCCESS\", \"success\": true, \"browser_tts\": true}, \"canonical_action_type\": \"MANUAL_BROADCAST\"}, \"legacy_action_type\": \"manual_broadcast\"}','2026-07-30 14:05:35','2026-08-02 19:33:03'),(4,1,48,NULL,NULL,NULL,'legacy:ba2727a9d9e54f268e47e6d4e6e22c85','ACTION','MANUAL','LOW','SUCCESS','SUCCESS','微信小程序工作人员','{\"legacy_payload\": {\"reason\": null, \"remark\": null, \"content\": null, \"assignee\": null, \"operator\": \"微信小程序工作人员\", \"to_status\": \"PROCESSING\", \"device_ids\": [], \"from_status\": \"PROCESSING\", \"template_id\": \"PERSON_LOW\", \"operator_role\": \"miniprogram\", \"assignee_phone\": null, \"broadcast_result\": {\"text\": \"您已进入安全警戒区域，请立即远离水边危险区域。\", \"items\": [{\"result\": \"SUCCESS\", \"message\": \"USB_AUDIO played via plughw:2,0\", \"device_id\": 2, \"device_name\": \"Jetson USB外放\", \"vendor_type\": \"USB_AUDIO\"}], \"result\": \"SUCCESS\", \"success\": true, \"browser_tts\": false}, \"canonical_action_type\": \"MANUAL_BROADCAST\"}, \"legacy_action_type\": \"manual_broadcast\"}','2026-07-31 07:08:53','2026-08-02 19:33:03'),(5,2,49,NULL,NULL,NULL,'legacy:25cbc5218ac4448589b88ee0fb7219d4','ACTION','AUTO','MEDIUM','SUCCESS','检测到人员','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"AI_DETECTED\"}','2026-07-30 08:10:40','2026-08-02 19:33:03'),(6,2,49,NULL,NULL,NULL,'legacy:c206bdf1f41f4fe980f2b23cdb19f1a6','ACTION','AUTO','LOW','SUCCESS','低风险，自动喊话','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_LOW\"}','2026-07-30 08:10:50','2026-08-02 19:33:03'),(7,2,49,NULL,NULL,NULL,'legacy:0c5e50756c5045a4a4101ccda947af13','ACTION','AUTO','MEDIUM','SUCCESS','中风险，再次自动喊话，无人机自动派飞','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_MEDIUM\"}','2026-07-30 08:11:30','2026-08-02 19:33:03'),(8,3,50,NULL,NULL,NULL,'legacy:aac3c16244df4a1e9a6b85bf72cb72fe','ACTION','AUTO','HIGH','SUCCESS','检测到人员','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"AI_DETECTED\"}','2026-07-30 08:08:00','2026-08-02 19:33:03'),(9,3,50,NULL,NULL,NULL,'legacy:0f3a61c2306a400b8e277c7cf95ae0e5','ACTION','AUTO','LOW','SUCCESS','低风险，自动喊话','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_LOW\"}','2026-07-30 08:08:10','2026-08-02 19:33:03'),(10,3,50,NULL,NULL,NULL,'legacy:ae6cf75622af4b0a82d760cb97fd4b73','ACTION','AUTO','MEDIUM','SUCCESS','中风险，再次自动喊话，无人机自动派飞','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_MEDIUM\"}','2026-07-30 08:08:50','2026-08-02 19:33:03'),(11,3,50,NULL,NULL,NULL,'legacy:174a99cc8bd147ef89c8144ee57abced','ACTION','AUTO','HIGH','SUCCESS','高风险，等待人工处理','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_HIGH\"}','2026-07-30 08:10:00','2026-08-02 19:33:03'),(12,3,50,NULL,NULL,NULL,'legacy:c269849ab7ac437ea00c50e9346a157d','ACTION','MANUAL','HIGH','SUCCESS','PARTIAL_SUCCESS','微信小程序工作人员','{\"legacy_payload\": {\"reason\": null, \"remark\": null, \"content\": null, \"assignee\": null, \"operator\": \"微信小程序工作人员\", \"to_status\": \"PENDING\", \"device_ids\": [], \"from_status\": \"PENDING\", \"template_id\": \"PERSON_HIGH\", \"operator_role\": \"miniprogram\", \"assignee_phone\": null, \"broadcast_result\": {\"text\": \"紧急警告，当前区域存在重大安全风险，请立即撤离。\", \"items\": [{\"result\": \"SUCCESS\", \"message\": \"LOCAL_AUDIO accepted\", \"device_id\": 1, \"device_name\": \"本机耳机/音响测试\", \"vendor_type\": \"LOCAL_AUDIO\"}, {\"result\": \"FAILED\", \"message\": \"USB_AUDIO only supports recorded audio playback\", \"device_id\": 2, \"device_name\": \"Jetson USB外放\", \"vendor_type\": \"USB_AUDIO\"}], \"result\": \"PARTIAL_SUCCESS\", \"success\": true, \"browser_tts\": true}, \"canonical_action_type\": \"MANUAL_BROADCAST\"}, \"legacy_action_type\": \"manual_broadcast\"}','2026-07-30 08:23:53','2026-08-02 19:33:03'),(13,3,50,NULL,NULL,NULL,'legacy:0dccb68bfb4d45aba8c8e8dac97265bf','ACTION','MANUAL','HIGH','SUCCESS','工作人员开始处理','微信小程序工作人员','{\"legacy_payload\": {\"remark\": null, \"operator\": \"微信小程序工作人员\", \"to_status\": \"MANUAL_PROCESSING\", \"from_status\": \"WAITING_MANUAL\", \"canonical_action_type\": \"STAFF_ACCEPTED\"}, \"legacy_action_type\": \"staff_accepted\"}','2026-07-30 08:24:48','2026-08-02 19:33:03'),(14,3,50,NULL,NULL,NULL,'legacy:a45b9a0646054bde93c1faa2f29709a6','ACTION','MANUAL','HIGH','SUCCESS','上传现场照片，完成处置','微信小程序工作人员','{\"legacy_payload\": {\"remark\": \"\", \"result\": \"OTHER\", \"operator\": \"微信小程序工作人员\", \"photo_url\": \"http://localhost:9000/dam/safety-events/field-results/mp_demo_high_001/2026-07-30/784d1044804b4317bca11938ebcbb4cc.jpg\", \"result_label\": \"其他\", \"canonical_action_type\": \"STAFF_COMPLETED\"}, \"legacy_action_type\": \"staff_completed\"}','2026-07-30 14:24:24','2026-08-02 19:33:03'),(15,3,50,NULL,NULL,NULL,'legacy:2de160274cd74dc9b2ebdad5d3d749ba','ACTION','MANUAL','HIGH','SUCCESS','其他，事件闭环','微信小程序工作人员','{\"legacy_payload\": {\"reason\": \"manual_close\", \"remark\": \"\", \"result\": \"OTHER\", \"operator\": \"微信小程序工作人员\", \"photo_url\": \"http://localhost:9000/dam/safety-events/field-results/mp_demo_high_001/2026-07-30/784d1044804b4317bca11938ebcbb4cc.jpg\", \"result_label\": \"其他\", \"canonical_action_type\": \"MANUAL_RESOLVED\"}, \"legacy_action_type\": \"event_manual_closed\"}','2026-07-30 14:24:24','2026-08-02 19:33:03'),(16,4,50,NULL,NULL,NULL,'legacy:76c043b406e1418293201c7111419c76','ACTION','AUTO','HIGH','SUCCESS','检测到人员','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"AI_DETECTED\"}','2026-07-30 08:04:40','2026-08-02 19:33:03'),(17,4,50,NULL,NULL,NULL,'legacy:f1a6893676dd458ea03f65266ac12c37','ACTION','AUTO','LOW','SUCCESS','低风险，自动喊话','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_LOW\"}','2026-07-30 08:04:50','2026-08-02 19:33:03'),(18,4,50,NULL,NULL,NULL,'legacy:f5dc7bd58daf45bd959059bcb8c56a72','ACTION','AUTO','MEDIUM','SUCCESS','中风险，再次自动喊话，无人机自动派飞','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_MEDIUM\"}','2026-07-30 08:05:30','2026-08-02 19:33:03'),(19,4,50,NULL,NULL,NULL,'legacy:d080d607adc44a259ef3d423f0dd43d7','ACTION','AUTO','HIGH','SUCCESS','高风险，等待人工处理','SYSTEM','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"RISK_HIGH\"}','2026-07-30 08:06:40','2026-08-02 19:33:03'),(20,4,50,NULL,NULL,NULL,'legacy:dcc92f4ece184573be0a1e893d9633ea','ACTION','MANUAL','HIGH','SUCCESS','工作人员开始处理','演示人员','{\"legacy_payload\": {\"source\": \"miniprogram_demo\"}, \"legacy_action_type\": \"staff_accepted\"}','2026-07-30 08:07:40','2026-08-02 19:33:03'),(21,4,50,NULL,NULL,NULL,'legacy:661f8b7ed9084ab688f85feff1c1ecda','ACTION','MANUAL','HIGH','SUCCESS','上传现场照片，完成处置','微信小程序工作人员','{\"legacy_payload\": {\"remark\": \"\", \"result\": \"DRIVEN_AWAY\", \"operator\": \"微信小程序工作人员\", \"photo_url\": \"http://localhost:9000/dam/safety-events/field-results/mp_demo_high_processing_001/2026-08-02/160743aaf6bf4635975a41d430d7e043.jpg\", \"result_label\": \"已完成驱离\", \"canonical_action_type\": \"STAFF_COMPLETED\"}, \"legacy_action_type\": \"staff_completed\"}','2026-08-02 07:46:23','2026-08-02 19:33:03'),(22,4,50,NULL,NULL,NULL,'legacy:942e571de8f745deb374816f5881fc18','ACTION','MANUAL','HIGH','SUCCESS','已完成驱离，事件闭环','微信小程序工作人员','{\"legacy_payload\": {\"reason\": \"manual_close\", \"remark\": \"\", \"result\": \"DRIVEN_AWAY\", \"operator\": \"微信小程序工作人员\", \"photo_url\": \"http://localhost:9000/dam/safety-events/field-results/mp_demo_high_processing_001/2026-08-02/160743aaf6bf4635975a41d430d7e043.jpg\", \"result_label\": \"已完成驱离\", \"canonical_action_type\": \"MANUAL_RESOLVED\"}, \"legacy_action_type\": \"event_manual_closed\"}','2026-08-02 07:46:23','2026-08-02 19:33:03'),(23,5,50,NULL,NULL,NULL,'legacy:29edcf90ddc045d984b2ccccd99c09bf','ACTION','MANUAL','HIGH','SUCCESS','SUCCESS','微信小程序工作人员','{\"legacy_payload\": {\"reason\": null, \"remark\": null, \"content\": null, \"assignee\": null, \"operator\": \"微信小程序工作人员\", \"to_status\": \"PROCESSING\", \"device_ids\": [], \"from_status\": \"PROCESSING\", \"template_id\": \"PERSON_HIGH\", \"operator_role\": \"miniprogram\", \"assignee_phone\": null, \"broadcast_result\": {\"text\": \"紧急警告，当前区域存在重大安全风险，请立即撤离。\", \"items\": [{\"result\": \"SUCCESS\", \"message\": \"USB_AUDIO played via plughw:2,0\", \"device_id\": 2, \"device_name\": \"Jetson USB外放\", \"vendor_type\": \"USB_AUDIO\"}], \"result\": \"SUCCESS\", \"success\": true, \"browser_tts\": false}, \"canonical_action_type\": \"MANUAL_BROADCAST\"}, \"legacy_action_type\": \"manual_broadcast\"}','2026-07-31 07:08:40','2026-08-02 19:33:03'),(24,5,50,NULL,NULL,NULL,'legacy:cf699e5e255948f9b161f9a1f340e242','ACTION','MANUAL','HIGH','SUCCESS','SUCCESS','微信小程序工作人员','{\"legacy_payload\": {\"reason\": null, \"remark\": null, \"content\": null, \"assignee\": null, \"operator\": \"微信小程序工作人员\", \"to_status\": \"PROCESSING\", \"device_ids\": [], \"from_status\": \"PROCESSING\", \"template_id\": \"PERSON_HIGH\", \"operator_role\": \"miniprogram\", \"assignee_phone\": null, \"broadcast_result\": {\"text\": \"紧急警告，当前区域存在重大安全风险，请立即撤离。\", \"items\": [{\"result\": \"SUCCESS\", \"message\": \"USB_AUDIO played via plughw:2,0\", \"device_id\": 2, \"device_name\": \"Jetson USB外放\", \"vendor_type\": \"USB_AUDIO\"}], \"result\": \"SUCCESS\", \"success\": true, \"browser_tts\": false}, \"canonical_action_type\": \"MANUAL_BROADCAST\"}, \"legacy_action_type\": \"manual_broadcast\"}','2026-07-31 08:56:18','2026-08-02 19:33:03'),(25,6,51,NULL,NULL,NULL,'legacy:b6d4cae8dfae487f927fcc315b406c0c','ACTION','AUTO','NONE','SUCCESS','安全事件已创建','SYSTEM','{\"legacy_payload\": {\"risk_level\": \"LOW\", \"snapshot_url\": \"/app/data/safety_snapshots/1785674381_evt_a46cba8199df4732ab77a5836112e75b.jpg\"}, \"legacy_action_type\": \"event_created\"}','2026-08-02 12:39:41','2026-08-02 12:40:58'),(26,6,51,NULL,NULL,NULL,'legacy:52b310024a6944ec979f75cf6506d0a9','ACTION','AUTO','LOW','SUCCESS','风险等级变化','SYSTEM','{\"legacy_payload\": {\"to\": \"LOW\", \"from\": \"NONE\", \"reason\": \"触发低风险区域规则\", \"to_handling_mode\": \"AUTO\", \"from_handling_mode\": \"AUTO\", \"to_disposal_status\": \"AUTO_HANDLING\", \"from_disposal_status\": \"MONITORING\"}, \"legacy_action_type\": \"RISK_CHANGED\"}','2026-08-02 12:39:41','2026-08-02 12:40:58'),(27,6,51,NULL,NULL,NULL,'legacy:4f40f99c94f24293bc62bb09c4b6ea91','ACTION','AUTO','LOW','PENDING','系统自动广播','SYSTEM','{\"legacy_payload\": {\"action_key\": \"evt_a46cba8199df4732ab77a5836112e75b:LOW:AUTO_BROADCAST:1\", \"risk_level\": \"LOW\", \"trigger_type\": \"AUTO\"}, \"legacy_action_type\": \"AUTO_BROADCAST\"}','2026-08-02 12:39:41','2026-08-02 12:40:58'),(28,6,51,NULL,NULL,NULL,'legacy:c422070ea0d74f6bbb9cd14c34397fe4','ACTION','AUTO','LOW','SUCCESS','目标离开危险区域','SYSTEM','{\"legacy_payload\": {\"clear_since\": 1785674381.3951442}, \"legacy_action_type\": \"TARGET_LEFT\"}','2026-08-02 12:39:41','2026-08-02 12:40:58'),(29,6,51,NULL,NULL,NULL,NULL,'RISK_CHANGE','MANUAL','MEDIUM','SUCCESS','人工将风险从低风险升级为中风险','admin','{\"action\": \"UPGRADE\", \"reason\": \"\"}','2026-08-02 13:20:36','2026-08-02 13:20:36');
/*!40000 ALTER TABLE `safety_event_timeline_log` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `schema_migration` VALUES ('20260802_eca_safety_integration_v1','2026-08-02 12:41:41');
...
--
-- Table structure for table `visual_event_detail`
--

DROP TABLE IF EXISTS `visual_event_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `visual_event_detail` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `event_instance_id` bigint NOT NULL,
  `camera_id` bigint NOT NULL,
  `camera_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `zone_name` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zone_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `confidence` decimal(8,6) DEFAULT NULL,
  `extra` json DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `event_instance_id` (`event_instance_id`),
  KEY `ix_visual_event_detail_target_type` (`target_type`),
  KEY `ix_visual_event_detail_zone_id` (`zone_id`),
  KEY `ix_visual_event_detail_target_id` (`target_id`),
  KEY `ix_visual_event_detail_camera_id` (`camera_id`),
  CONSTRAINT `visual_event_detail_ibfk_1` FOREIGN KEY (`event_instance_id`) REFERENCES `safety_event_instance` (`id`) ON DELETE CASCADE,
  CONSTRAINT `visual_event_detail_ibfk_2` FOREIGN KEY (`camera_id`) REFERENCES `camera_device` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `visual_event_detail_ibfk_3` FOREIGN KEY (`zone_id`) REFERENCES `camera_detection_zone` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `visual_event_detail`
--

LOCK TABLES `visual_event_detail` WRITE;
/*!40000 ALTER TABLE `visual_event_detail` DISABLE KEYS */;
INSERT INTO `visual_event_detail` VALUES (1,1,1,'一号点摄像头','person','track_mp_demo_low_001',NULL,'警戒区','WARNING_ZONE',NULL,'{\"bbox\": {\"x\": 0.42, \"y\": 0.36, \"width\": 0.16, \"height\": 0.32}}','2026-08-02 19:33:03','2026-08-02 19:33:03'),(2,2,1,'一号点摄像头','person','track_mp_demo_medium_001',NULL,'亲水区','WATERFRONT_ZONE',NULL,'{\"bbox\": {\"x\": 0.42, \"y\": 0.36, \"width\": 0.16, \"height\": 0.32}}','2026-08-02 19:33:03','2026-08-02 19:33:03'),(3,3,1,'一号点摄像头','person','track_mp_demo_high_001',NULL,'涉水区','WATER_ZONE',NULL,'{\"bbox\": {\"x\": 0.42, \"y\": 0.36, \"width\": 0.16, \"height\": 0.32}}','2026-08-02 19:33:03','2026-08-02 19:33:03'),(4,4,1,'一号点摄像头','person','track_mp_demo_high_processing_001',NULL,'涉水区','WATER_ZONE',NULL,'{\"bbox\": {\"x\": 0.42, \"y\": 0.36, \"width\": 0.16, \"height\": 0.32}}','2026-08-02 19:33:03','2026-08-02 19:33:03'),(5,5,1,'一号点摄像头','person','track_mp_demo_high_processing_001',NULL,'涉水区','WATER_ZONE',NULL,'{\"bbox\": {\"x\": 0.42, \"y\": 0.36, \"width\": 0.16, \"height\": 0.32}}','2026-08-02 19:33:03','2026-08-02 19:33:03');
/*!40000 ALTER TABLE `visual_event_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-08-02 13:37:11
