...
class ModelConfig:
    """模型配置。"""
    weights_path: str = "/app/models/mobilenetv4_conv_medium_cls_default.pt"
    backend: str = "timm"
...
def load_config() -> tuple[MinIOConfig, ModelConfig, ServerConfig]:
    ...
    model_config = ModelConfig(
        weights_path=os.getenv("MODEL_WEIGHTS", "/app/models/mobilenetv4_conv_medium_cls_default.pt"),
