...
class ModelConfig:
    """模型配置。"""
    weights_path: str = "/app/models/yolo26x_cls_default.pt"
    backend: str = "yolo"
    model_name: str = ""
    device: str = "0"
    img_size: int = 256
...
def load_config() -> tuple[MinIOConfig, ModelConfig, ServerConfig]:
    ...
    model_config = ModelConfig(
        weights_path=os.getenv("MODEL_WEIGHTS", "/app/models/yolo26x_cls_default.pt"),
        backend=os.getenv("MODEL_BACKEND", "yolo"),
