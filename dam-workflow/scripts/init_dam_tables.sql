...
-- 滑坡事件→模型映射示例
-- INSERT INTO model_event_mapping (event_type, task_type, model_category, model_id, priority, remark) VALUES
-- ('滑坡', '滑坡区域检测', 'specialized', 1, 10, 'YOLOv8 滑坡检测模型'),
-- ('滑坡', '滑坡边界分割', 'specialized', 2, 10, 'U-Net 滑坡分割模型'),
-- ('滑坡', '风险推理与处置建议', 'llm', 3, 10, '0.8B 轻量大模型');
